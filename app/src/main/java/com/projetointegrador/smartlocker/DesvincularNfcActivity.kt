...
class DesvincularNfcActivity : AppCompatActivity() {

    private lateinit var nfcAdapter: NfcAdapter
    private lateinit var binding: ActivityDesvincularNfcBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDesvincularNfcBinding.inflate(layoutInflater)
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED == intent.action) {
            /*val i = Intent(this, "activity de encerrar"::class.java)
            startActivity(i)*/
